...
set PLATFORM    "asap7" ;# 工艺平台名称

# --- 路径配置 ---
set PLATFORM_DIR "./platforms/${PLATFORM}"
set SYNTH_VERILOG_FILE "./results/separated/synth/aes_synth.v"
set SDC_FILE "./designs/${PLATFORM}/${DESIGN_NAME}/constraint.sdc"
set RESULTS_DIR "./results/${PLATFORM}/${DESIGN_NAME}/floorplan"
file mkdir $RESULTS_DIR

# === 技术文件配置 ===
set TECH_LEF    "${PLATFORM_DIR}/lef/asap7_tech_1x_201209.lef"
set SC_LEF      "${PLATFORM_DIR}/lef/fakeram_256x128.lef"
set LIB_FILES   "${PLATFORM_DIR}/lib/NLDM/asap7sc7p5t_SEQ_RVT_TT_nldm_220123.lib"
...
# openroad -no_splash -exit /mnt/hgfs/share_dir/open-road-issue/gcd_floorplan.tcl
